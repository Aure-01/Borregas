        ...
        <div class="contenedor-head">
            ...
            <div class="menu">
                <ul class="nav nav-pills">
                    <li class="nav-item"><a href="<?php echo base_url('/home'); ?>" class="nav-link"
                    ...
                    <li class="nav-item"><a href="<?php echo base_url('/clientes'); ?>" class="nav-link">Clientes</a>
                    </li>
                    <li class="nav-item"><a href="<?php echo base_url('/empleados'); ?>" class="nav-link">Empleados</a>
                    </li>
                    ...
                    <li class="nav-item"><a href="<?php echo base_url('/reportes'); ?>" class="nav-link">Reportes</a>
                    </li>
                    <?php } elseif (session('usuario')->fkidrol == '2') { ?>
                    <li class="nav-item"><a href="<?php echo base_url('/empleados/agregar-venta'); ?>"
                            class="nav-link">Ventas</a></li>
                    <?php } ?>
                    <li class="nav-item"><a href="<?php echo base_url('/vistas/nosotros'); ?>"
                    ...
                    <li><button class="btn" data-bs-toggle="modal" data-bs-target="#exampleModal"><i
