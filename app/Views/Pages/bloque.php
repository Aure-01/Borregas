...
<table class="table table-hover" id="tablaBloque" name="tablaBloque">
    ...
    <tbody id="resultBloque" name="resultBloque">
        ...
        <tr>
            ...
            <td>
                <a href="<?php echo base_url('/bloque/eliminar/' . $row->id_bloque); ?>"><button
                        class="btn btn-danger">Eliminar</button></a>
                <a href="<?php echo base_url('/bloque/editar/' . $row->id_bloque); ?>"><button
                        class="btn btn-warning">Editar</button></a>
                <a href="<?php echo base_url('/bloque/plantillaAumentarExistencia/' . $row->id_bloque); ?>"><button
