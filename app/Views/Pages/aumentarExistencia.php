...
<center>
    <div class="form-aumentar">
        <form action="<?php echo base_url('/bloque/aumentarExistencia/' . $row->id_bloque); ?>" method="post"
            ...
            <div class="row g-3">
                <div class="col-md-5">
                    <label for="adicion" class="form-label">¿Cuanto deseas agregar
                        <?php echo $row->blq_nombre;?> <?php echo $row->blq_tamano; ?>?</label>
                    <input type="text" class="form-control" pattern="[0-9]+" min="1" id="adicion" name="adicion"
                        required>
                </div>
