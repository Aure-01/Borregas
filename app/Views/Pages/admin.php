...
<div class="cards-cliente">
    ...
    <div class="card-product-cliente">
        ...
        <button type="button" value="<?php echo $valor; ?>" id="<?php echo $bloque->id_bloque; ?>"
            class="btn btn-success" data-bs-toggle="modal" data-bs-target="#exampleModal"
            onclick="carritoDeCompra(id);">
    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                ...
                <button type="submit" id="btn-comprar" form="formCarrito" class="btn btn-primary"
